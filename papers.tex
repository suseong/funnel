...
\begin{align}
C(R^TR_d) &= (1+2\cos\theta)I_3 - (I_3 + \sin\theta\hat{K} + (1-\cos\theta)\hat{K}^2) \nonumber \\
&= 2\cos\theta I_3 + \sin\theta\hat{K} + (1-\cos\theta)\hat{K}^2 \nonumber \\
&= 2\cos\theta I_3 + \hat{e}_R +\frac{1-\cos\theta}{\sin^2\theta}\hat{e}_R^2 \nonumber \\
&= 2\cos\theta I_3 + \hat{e}_R +\frac{1}{1+\cos\theta}\hat{e}_R^2 \nonumber
\end{align}
