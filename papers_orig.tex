...
%\right] +e^T\dot{P}e\nonumber \\
%&= e^T(PA+A^TP)e \nonumber \\
%&\;\;\;\;+ 2|-K_p e_p -K_v e_v - ge_3 + \dot{v}_r|e^T
%\left[
%\begin{array}{c}
%P_{pv} \\ P_v
%\end{array}
%\right]
%\{(e_3^TR_d^TRe_3)R_de_3-Re_3\} +e^T\dot{P}e\nonumber \\
%&\leq e^T(PA+A^TP)e+ E_R(p_{pv}|e_p|+p_v|e_v|)(k_p|e_p|+k_v|e_v|+B)+e^T\dot{P}e \nonumber  \\
%&\leq e^T(PA+A^TP)e+ E_R(p_{pv}\bar{e}_p+p_v\bar{e}_v)(k_p\bar{e}_p+k_v\bar{e}_v+B)+e^T\dot{P}e \nonumber
%&\leq e^TPAe \nonumber \\
